...
import PostDetail from '../component/PostContent/PostDetail';
import PostEdit from '../component/PostContent/PostEdit';
import CreatePost from '../component/PostContent/CreatePost';
import './Blog.css';
    ...
    render(){  
        ...
        return(
            <div className="Blog">                
                ...
                {/* <PostContent id={this.state.postId} isClick={this.state.isClicked} getListPost={this.getListPost}/> */}
