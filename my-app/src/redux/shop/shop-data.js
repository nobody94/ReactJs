...
const hat = importAll(require.context('../../assets/hat/'));
const sneaker = importAll(require.context('../../assets/sneaker/'));
const jacket = importAll(require.context('../../assets/jacket/'));
const women = importAll(require.context('../../assets/women/'));
const men = importAll(require.context('../../assets/men/'));
